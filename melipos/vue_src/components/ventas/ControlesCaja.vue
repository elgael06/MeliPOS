<template>
	<div class="card-header text-white" style="background:#62bbee">
		<div class="row">
			...
			<form class="col-sm-12" @submit.prevent="buscar_producto"  style="max-width:405px;display:inline-block;float:left">
			...
			<div class="col-sm-6 mt-3" style="margin:auto;max-width:405px;display:inline-block;float:right">
		...
		<BuscarProductos v-bind:productos="busqueda_productos" v-bind:seleccion="producto_seleccionado" />
	</div>
</template>
